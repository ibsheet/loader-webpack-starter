...
console.log('* IBSheetLoader.version:', loaderVersion)
const verEl = document.getElementById('ibsheetLoaderVer')
verEl.innerHTML = loaderVersion

// configuration
loader.config({ debug: true })

// load ibsheet
const IBSHEET_BASEURL = '//dev.ibleaders.com/lib/ibsheet-js'
loader.load({
  name: 'ibsheet',
...
loader.createSheet(sheetOpts).then(function(sheet) {
